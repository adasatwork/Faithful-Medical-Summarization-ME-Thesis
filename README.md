...
First, we introduce BioQ-HEAL, an economical two-stage cascaded pipeline.
...
BioQ-HEAL provides a highly efficient, balanced approach, achieving the highest reference overlap across both datasets (e.g., top ROUGE-1 scores of 0.5209 for radiology and 0.3495 for health questions).
